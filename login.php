...
<html lang="en">
  <head>
    ...
    <title>Contact Systemm Specs</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
                <div class="auth-form-light text-left p-5">
                    <h3>Contact System Specs</h3>
                    <h6 class="font-weight-light">Sign in to continue.</h6>
                    <form id="frmuser" class="pt-3" method="post" data-parsley-validate="">
                        <div class="error-message"></div>
                        <div class="form-group">
                            <input class="form-control form-control-lg" id="email" name="email" placeholder="Email" data-parsley-required="" data-parsley-required-message="Email is required." data-parsley-errors-container="#email-error">
                        ...
                        <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="<?php BASE_URL ?>/register.php" class="text-primary">Create</a>
                        </div>
                    </form>
                </div>
            </div>
